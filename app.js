...
const quizattemptRouter = require('./src/routes/quizattempt');
...
app.use('/' + config.server.route + '/quiz', quizRouter);
app.use('/' + config.server.route + '/attempt', quizattemptRouter);
